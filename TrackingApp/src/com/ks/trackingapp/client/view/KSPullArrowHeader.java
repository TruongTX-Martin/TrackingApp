 ...
 *
 */
public class KSPullArrowHeader extends Composite implements PullArrowWidget {
	
	/**
	 * 
	 */
	private static KSPullArrowHeaderUiBinder uiBinder = GWT.create(KSPullArrowHeaderUiBinder.class);

	interface KSPullArrowHeaderUiBinder extends UiBinder<Widget, KSPullArrowHeader> {
	}
	
	@UiField protected FlowPanel loadingPanel;
	@UiField protected HTML htmlLoading;
	
	public KSPullArrowHeader() {
