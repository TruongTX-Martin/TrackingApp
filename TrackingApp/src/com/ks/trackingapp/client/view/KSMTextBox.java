 ...
 *
 */
public class KSMTextBox extends MTextBox {
	/**
	 * 
	 */
	public KSMTextBox() {
		super();
//		this.setStyleName(CssToken.INPUT_PRIMARY, true);
	...
	public void onBrowserEvent(Event event) {
		...
		case Event.ONKEYDOWN: 
			...
			box.getElement().getStyle().setBackgroundColor("transparent");
	...
	public String getType() {
		return box.getElement().getAttribute("type");
	}
